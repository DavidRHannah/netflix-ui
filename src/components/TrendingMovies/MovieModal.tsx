          ...
          <div className="grid lg:grid-cols-3 gap-4 sm:gap-8">
            <div className="modal-main-content lg:col-span-2 space-y-3 sm:space-y-6">
              ...
              {movie.awards && movie.awards !== "N/A" && (
                <div>
                  ...
                  <p className="text-gray-300 text-sm sm:text-base leading-5">{movie.awards}</p>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 sm:hidden">
                    {movie.ratings.map((rating, index) => (
                      ...
                      >
                        <span className="text-gray-400 font-medium">{rating.Source}:</span>
            ...
            <div className="modal-sidebar flex justify-between sm:flex-col space-y-0 sm:space-y-6">
              <div className="sidebar-priority-one flex flex-col gap-2">
                <div>
                <h4 className="text-white font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Director</h4>
                <p className="text-gray-300 text-sm sm:text-base leading-5">
                  {formatDirectors(movie.director)}
                </p>
                </div>
                <div>
                  <h4 className="text-white font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Cast</h4>
                  <p className="text-gray-300 text-sm sm:text-base leading-5">{formatActors(movie.actors)}</p>
                </div>
                <div>
                  <h4 className="text-white font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Genres</h4>
